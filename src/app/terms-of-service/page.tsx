       ...
       >
         <div className="prose prose-lg max-w-none">
           ...
           <section id="informazioni-titolare" className="mb-8">
             <h2 className="text-2xl font-bold text-gray-900 mb-4">1. Informazioni sul Titolare</h2>
           ...
           <section id="oggetto-servizio" className="mb-8">
             ...
             <ol className="list-decimal list-inside space-y-2 mb-4">
               ...
               <li className="text-gray-700">Invio della comunicazione per conto dell'Utente, tramite PEC, raccomandata digitale o sistemi equivalenti.</li>
             ...
             <ul className="list-disc list-inside space-y-2 mb-4">
               ...
               <li className="text-gray-700">firmarla digitalmente ove richiesto dai sistemi PEC,</li>
               <li className="text-gray-700">trasmetterla alla Società destinataria,</li>
               <li className="text-gray-700">conservare la prova dell'invio.</li>
             </ul>
           ...
           <section id="mandato" className="mb-8">
             <h2 className="text-2xl font-bold text-gray-900 mb-4">4. Mandato con rappresentanza - Conferimento</h2>
             <p className="text-gray-700 leading-relaxed mb-4">
               Il mandato si intende conferito dall'Utente mediante:
             </p>
             <ol className="list-decimal list-inside space-y-2 mb-4">
               <li className="text-gray-700">caricamento del documento d'identità;</li>
               <li className="text-gray-700">compilazione dei dati richiesti;</li>
               <li className="text-gray-700">selezione della checkbox contenente l'autorizzazione;</li>
               <li className="text-gray-700">conferma della richiesta di invio.</li>
             </ol>
             <p className="text-gray-700 leading-relaxed">
           ...
           <section id="veridicita" className="mb-8">
             <h2 className="text-2xl font-bold text-gray-900 mb-4">5. Veridicità delle informazioni e responsabilità dell'Utente</h2>
             <p className="text-gray-700 leading-relaxed mb-4">
               L'Utente dichiara e garantisce che:
             </p>
             <ul className="list-disc list-inside space-y-2 mb-4">
               <li className="text-gray-700">è titolare effettivo del rapporto contrattuale oggetto della comunicazione;</li>
               <li className="text-gray-700">i dati forniti sono veri, completi e aggiornati;</li>
               <li className="text-gray-700">i documenti allegati sono autentici e validi;</li>
               <li className="text-gray-700">l'utilizzo della Piattaforma non viola diritti di terzi.</li>
             </ul>
             <p className="text-gray-700 leading-relaxed mb-4">
             ...
             <ul className="list-disc list-inside space-y-2">
               <li className="text-gray-700">errori nei dati forniti,</li>
               <li className="text-gray-700">documenti falsi o non leggibili,</li>
               <li className="text-gray-700">contestazioni della Società destinataria relative alla legittimazione.</li>
             </ul>
           </section>
           ...
           <section id="limitazioni" className="mb-8">
             ...
             <ul className="list-disc list-inside space-y-2 mb-4">
               <li className="text-gray-700">ritardi, errori o rifiuti della Società destinataria;</li>
               <li className="text-gray-700">mancata ricezione causata da caselle PEC piene/chiuse/non attive;</li>
               <li className="text-gray-700">interruzioni tecniche dei provider PEC o servizi terzi;</li>
               <li className="text-gray-700">utilizzo fraudolento del servizio da parte di terzi;</li>
               <li className="text-gray-700">mancato esito desiderato (es. mancato recesso, mancato rimborso).</li>
             </ul>
           ...
           <section id="disponibilita" className="mb-8">
             ...
             <ul className="list-disc list-inside space-y-2 mb-4">
               <li className="text-gray-700">manutenzioni programmate;</li>
               <li className="text-gray-700">sospensioni per motivi tecnici o di sicurezza;</li>
               <li className="text-gray-700">blocchi temporanei dei provider di invio.</li>
             </ul>
             <p className="text-gray-700 leading-relaxed">
           ...
           <section id="prezzi" className="mb-8">
             <h2 className="text-2xl font-bold text-gray-900 mb-4">8. Prezzi, pagamenti e fatturazione</h2>
             <p className="text-gray-700 leading-relaxed mb-4">
             ...
             <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded">
               <h3 className="font-bold text-gray-900 mb-2">⚠️ Recesso non applicabile</h3>
               <p className="text-gray-700 leading-relaxed">
           ...
           <section id="uso-illecito" className="mb-8">
             <h2 className="text-2xl font-bold text-gray-900 mb-4">9. Uso illecito del Servizio</h2>
             <p className="text-gray-700 leading-relaxed mb-4">
               È vietato utilizzare la Piattaforma per:
             </p>
             <ul className="list-disc list-inside space-y-2 mb-4">
               <li className="text-gray-700">inviare comunicazioni diffamatorie, minacciose o abusive;</li>
               <li className="text-gray-700">impersonare terzi;</li>
               <li className="text-gray-700">eseguire attività fraudolente;</li>
           ...
           <section id="modifica" className="mb-8">
             ...
             <ul className="list-disc list-inside space-y-2 mb-4">
               <li className="text-gray-700">pubblicazione sul sito, oppure</li>
               <li className="text-gray-700">email all'Utente registrato.</li>
             </ul>
             <p className="text-gray-700 leading-relaxed">
           ...
           <section id="legge" className="mb-8">
             <h2 className="text-2xl font-bold text-gray-900 mb-4">11. Legge applicabile e foro competente</h2>
             <p className="text-gray-700 leading-relaxed mb-4">
               I presenti Termini sono regolati dalla legge italiana.
             </p>
             <ul className="list-disc list-inside space-y-2">
               <li className="text-gray-700">Se l'Utente è consumatore → foro del luogo di residenza.</li>
               <li className="text-gray-700">Se l'Utente è professionista → foro esclusivo Roma.</li>
             </ul>
           </section>
         </div>
       </motion.div>

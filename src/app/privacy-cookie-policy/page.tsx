...
export default function PrivacyPage() {
  ...
  const scrollToSection = (sectionId: string) => {
    ...
    if (element) {
      const offset = 140 // ✅ Aumentato da 120 a 140 (navbar + sticky pills + gap)
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-2xl mx-auto">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm text-gray-600">Come trattiamo i tuoi dati</div>
                </div>
              </button>
              ...
              >
                ...
                <div className="text-left">
                  <div className="font-bold text-gray-900">Cookie Policy</div>
                  <div className="text-sm text-gray-600">Gestione cookie e tracking</div>
                </div>
              </button>
            </div>
          </motion.div>
        ...
        >
          <div className="prose prose-lg max-w-none">
            ...
            <div id="privacy-policy" className="scroll-mt-20">
              <h1 className="text-3xl font-bold text-gray-900 mb-8 pb-4 border-b-2 border-indigo-200">
                📋 Privacy Policy
              </h1>
              ...
              <section id="dati-trattati" className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">2. Tipologie di dati trattati</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  La Piattaforma tratta le seguenti categorie di dati:
                </p>

                <h3 className="text-xl font-semibold text-gray-900 mb-3">2.1 Dati forniti volontariamente dall'Utente</h3>
                <ul className="list-disc list-inside space-y-2 mb-6">
                  <li className="text-gray-700">nome, cognome;</li>
                  <li className="text-gray-700">indirizzo email e/o PEC;</li>
                  <li className="text-gray-700">codice fiscale;</li>
                  <li className="text-gray-700">indirizzo di residenza;</li>
                  <li className="text-gray-700">dati relativi al contratto da disdire/recedere/diffidare;</li>
                  <li className="text-gray-700">documento di identità (fronte/retro).</li>
                </ul>

                <h3 className="text-xl font-semibold text-gray-900 mb-3">2.2 Dati trattati automaticamente</h3>
                <ul className="list-disc list-inside space-y-2 mb-6">
                  <li className="text-gray-700">indirizzo IP;</li>
                  <li className="text-gray-700">user agent, tipo dispositivo, browser;</li>
                  <li className="text-gray-700">log di accesso, timestamp e tracciati di caricamento documenti;</li>
                  <li className="text-gray-700">cookie tecnici e, solo previo consenso, cookie di analytics o marketing.</li>
                </ul>

                <h3 className="text-xl font-semibold text-gray-900 mb-3">2.3 Dati relativi all'uso del servizio</h3>
                <ul className="list-disc list-inside space-y-2">
                  <li className="text-gray-700">documenti generati (disdette, diffide, reclami);</li>
                  <li className="text-gray-700">ricevute PEC inviate e ricevute;</li>
                  <li className="text-gray-700">metadati (ID messaggi, consegna, accettazione).</li>
                </ul>
              </section>

              {/* Section 3 - Finalità */}
              <section id="finalita" className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">3. Finalità del trattamento e basi giuridiche</h2>
              ...
              <section id="modalita" className="mb-8">
                ...
                <ul className="list-disc list-inside space-y-2 mb-4">
                  <li className="text-gray-700">strumenti elettronici;</li>
                  <li className="text-gray-700">protocolli crittografati;</li>
                  <li className="text-gray-700">sistemi certificati PEC e cloud UE;</li>
                  <li className="text-gray-700">misure tecniche e organizzative idonee ex art. 32 GDPR.</li>
                </ul>
              ...
              <section id="conservazione" className="mb-8">
                ...
                <ul className="list-disc list-inside space-y-2 mb-4">
                  <li className="text-gray-700">tutela giudiziaria del Titolare;</li>
                  <li className="text-gray-700">tracciabilità del mandato;</li>
                  <li className="text-gray-700">prevenzione frodi.</li>
                </ul>
                <p className="text-gray-700 leading-relaxed">
              ...
              <section id="destinatari" className="mb-8">
                ...
                <ul className="list-disc list-inside space-y-2 mb-4">
                  <li className="text-gray-700">provider PEC e servizi di raccomandata digitale;</li>
                  <li className="text-gray-700">fornitori cloud con server in UE;</li>
                  <li className="text-gray-700">eventuali consulenti (commercialisti, avvocati, tecnici IT) nominati Responsabili esterni;</li>
                  <li className="text-gray-700">autorità giudiziaria, solo se richiesto.</li>
                </ul>
              ...
              <section id="trasferimento" className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">7. Trasferimento extra-UE</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <section id="diritti" className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">8. Diritti dell'Utente (artt. 15-22 GDPR)</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  L'Utente può esercitare i seguenti diritti scrivendo al Titolare:
                </p>
                <ul className="list-disc list-inside space-y-2 mb-4">
                  <li className="text-gray-700">accesso ai dati;</li>
                  <li className="text-gray-700">rettifica;</li>
                  <li className="text-gray-700">cancellazione ("diritto all'oblio");</li>
                  <li className="text-gray-700">limitazione;</li>
                  <li className="text-gray-700">portabilità;</li>
                  <li className="text-gray-700">opposizione;</li>
                  <li className="text-gray-700">revoca del consenso.</li>
                </ul>
                <div className="bg-indigo-50 rounded-xl p-6 border border-indigo-100">
              ...
              <section id="conferimento" className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">9. Natura del conferimento dei dati</h2>
                <ul className="list-disc list-inside space-y-2">
              ...
              <section id="sicurezza" className="mb-8">
                ...
                <ul className="list-disc list-inside space-y-2">
                  <li className="text-gray-700">cifratura dei documenti caricati;</li>
                  <li className="text-gray-700">accesso protetto ai file;</li>
                  <li className="text-gray-700">registri di trattamento;</li>
                  <li className="text-gray-700">firewall e sistemi anti-intrusione;</li>
                  <li className="text-gray-700">conservazione su server certificati ISO 27001.</li>
                </ul>
              </section>

              {/* Section 11 - Profilazione */}
              <section id="profilazione" className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">11. Profilazione e IA</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <section id="modifiche-privacy" className="mb-12">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">13. Modifiche all'informativa</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
            ...
            {/* ========================================
                COOKIE POLICY
            ======================================== */}
            <div id="cookie-policy" className="scroll-mt-20 border-t-2 border-gray-200 pt-12">
              <h1 className="text-3xl font-bold text-gray-900 mb-8 pb-4 border-b-2 border-indigo-200">
                🍪 Cookie Policy
              </h1>
              ...
              <section id="cosa-sono" className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">2. Cosa sono i Cookie</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <ul className="list-disc list-inside space-y-2 mb-4">
                  <li className="text-gray-700">Cookie tecnici o necessari</li>
                  <li className="text-gray-700">Cookie di analisi (analytics)</li>
                  <li className="text-gray-700">Cookie di profilazione/marketing</li>
                </ul>
                <p className="text-gray-700 leading-relaxed">
              ...
              <section id="cookie-tecnici" className="mb-8">
                ...
                <ul className="list-disc list-inside space-y-2 mb-4">
                  ...
                  <li className="text-gray-700">la gestione della sessione;</li>
                  <li className="text-gray-700">l'erogazione del servizio richiesto dall'Utente;</li>
                  <li className="text-gray-700">la sicurezza della piattaforma;</li>
                  <li className="text-gray-700">il salvataggio delle preferenze di lingua o layout.</li>
                </ul>
                <p className="text-gray-700 leading-relaxed">
              ...
              <section id="cookie-analytics" className="mb-8">
                ...
                <ul className="list-disc list-inside space-y-2 mb-6">
                  <li className="text-gray-700">anonimizzino l'indirizzo IP;</li>
                  <li className="text-gray-700">non permettano identificazione dell'utente;</li>
                  <li className="text-gray-700">siano utilizzati solo per statistiche aggregate.</li>
                </ul>

                <h3 className="text-xl font-semibold text-gray-900 mb-3">4.2 Analytics non anonimizzati</h3>
                <p className="text-gray-700 leading-relaxed">
              ...
              <section id="cookie-profilazione" className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">5. Cookie di profilazione e marketing</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Sono cookie utilizzati per:
                </p>
                <ul className="list-disc list-inside space-y-2 mb-4">
                  <li className="text-gray-700">inviare pubblicità personalizzata;</li>
                  <li className="text-gray-700">tracciare la navigazione su più siti;</li>
                  <li className="text-gray-700">misurare prestazioni delle campagne pubblicitarie;</li>
                  <li className="text-gray-700">attività di remarketing (es. tramite Meta/Google).</li>
                </ul>
                <p className="text-gray-700 leading-relaxed">
              ...
              <section id="cookie-terze-parti" className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">6. Cookie di terze parti</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Sono installati da servizi esterni al sito, tra cui:
                </p>
                <ul className="list-disc list-inside space-y-2 mb-4">
                  <li className="text-gray-700">Google LLC (Google Analytics, Google Ads, Tag Manager)</li>
                  <li className="text-gray-700">Meta Platforms (Meta Pixel)</li>
                  <li className="text-gray-700">Strumenti di invio PEC o tracciamento email</li>
                  <li className="text-gray-700">Provider cloud o CDN</li>
                </ul>
                <p className="text-gray-700 leading-relaxed">
              ...
              <section id="banner" className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">7. Banner Cookie - Obblighi del sito</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Al primo accesso, il sito deve mostrare un banner conforme, che consente di:
                </p>
                <ul className="list-disc list-inside space-y-2 mb-4">
                  <li className="text-gray-700">Accettare tutti i cookie</li>
                  <li className="text-gray-700">Rifiutare tutti i cookie non necessari</li>
                  <li className="text-gray-700">Gestire le preferenze</li>
                </ul>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Il banner deve:
                </p>
                <ul className="list-disc list-inside space-y-2">
                  <li className="text-gray-700">bloccare preventivamente tutti i cookie non tecnici;</li>
                  <li className="text-gray-700">salvare e rispettare la scelta dell'utente;</li>
                  <li className="text-gray-700">permettere di modificare le preferenze in ogni momento (es. "Rivedi preferenze cookie").</li>
                </ul>
              </section>
              ...
              <section id="consensi" className="mb-8">
                ...
                <ul className="list-disc list-inside space-y-2 mb-4">
                  ...
                  <li className="text-gray-700">preferenze selezionate;</li>
                  <li className="text-gray-700">ID cookie policy;</li>
                  <li className="text-gray-700">eventuali modifiche successive.</li>
                </ul>
                <p className="text-gray-700 leading-relaxed">
              ...
              <section id="gestione-browser" className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">9. Gestione Cookie tramite browser</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  L'Utente può disabilitare o cancellare i cookie attraverso le impostazioni del proprio browser:
                </p>
                <ul className="list-disc list-inside space-y-2 mb-4">
                  <li className="text-gray-700">Chrome</li>
                  <li className="text-gray-700">Safari</li>
                  <li className="text-gray-700">Firefox</li>
                  <li className="text-gray-700">Edge</li>
                  <li className="text-gray-700">Opera</li>
                </ul>
                <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded">
                  <p className="text-gray-800 font-medium">
              ...
              <section id="trasferimento-cookie" className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">10. Trasferimento dati extra-UE</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <ul className="list-disc list-inside space-y-2">
                  <li className="text-gray-700">Clausole Contrattuali Standard (SCC);</li>
                  <li className="text-gray-700">misure tecniche supplementari (es. cifratura, minimizzazione);</li>
                  <li className="text-gray-700">verifiche di adeguatezza ai sensi dell'art. 46 GDPR.</li>
                </ul>
              </section>

              {/* Section 11 - Diritti Cookie */}
              <section id="diritti-cookie" className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">11. Diritti dell'Utente</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  L'Utente può esercitare in ogni momento i diritti previsti dal GDPR:
                </p>
                <ul className="list-disc list-inside space-y-2 mb-4">
                  <li className="text-gray-700">accesso;</li>
                  <li className="text-gray-700">rettifica;</li>
                  <li className="text-gray-700">cancellazione;</li>
                  <li className="text-gray-700">limitazione;</li>
                  <li className="text-gray-700">opposizione;</li>
                  <li className="text-gray-700">portabilità;</li>
                  <li className="text-gray-700">revoca del consenso.</li>
              ...
              <section id="modifiche-cookie" className="mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">12. Modifiche alla Cookie Policy</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Il Titolare può modificare la presente informativa.
                </p>
                <p className="text-gray-700 leading-relaxed">
